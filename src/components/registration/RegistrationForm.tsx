...
interface RegistrationFormProps {
  ...
  dietaryRestrictions: Array<{ id: string; name: string }>;
}
...
export function RegistrationForm({
  ...
  const [dietaryData, setDietaryData] = useState<Partial<DietaryFormData>>({});
  ...
  useEffect(() => {
    async function checkStatus() {
      ...
      if (status.registered && status.registrationData) {
        ...
        const { profile, education, shipping, dietaryRestrictions: dietaryRestrictionsData, mlhAgreement } = status.registrationData;
        setProfileData({
